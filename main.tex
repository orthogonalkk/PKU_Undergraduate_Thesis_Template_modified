...
\pkuthssinfo{
	...
	ctitle = {\zihao{2}{以手机为核心的远程控制系统}},
	etitle = {\zihao{5}{A remote control system based on a mobile phone}},
	cauthor = {黄轩拓}, eauthor = {Xuantuo\ Huang},
	studentid = {1900012628},
	% 具体时间以教务为准，初稿3月，送审4月，答辩5月，最终6月。
	date = {\zhdigits{2023}\ \ 年\ \ \zhnumber{5}\ \ 月},
	school = {信息科学技术学院},
	cmajor = {电子信息科学与技术}, emajor = {xxx},
	direction = {XXXX},
	mentorlines = {1}, % 导师个数
	% 副教授 A.P. 讲师 Lec.
	cmentor = {许胜勇\ \ 教授}, ementor = {Prof.\ XXX},
	ckeywords = {视障人群，人工视觉，导航，信息传输},
	ekeywords = {People with impaired vision, Artificial vision, Navigation, Data transmission},
